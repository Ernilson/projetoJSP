...
public class CalculoHoraExtra {
    ...
    public CalculoHoraExtra(String data, String entradaPrevista, String entradaRealizada, String saidaPrevista, String saidaRealizada, int horaExtraEntrada, int horaExtraSaida) {
        this.data = data;
